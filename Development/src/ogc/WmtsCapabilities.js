...
define([
    ...
    function (ArgumentError,
         ...
         * @constructor
         * @classdesc Represents an OGC WorldWeather capabilities document.
         * This object holds as properties all the fields specified in the OGC WorldWeather capabilities document.
         ...
         * @param {{}} xmlDom An XML DOM representing the OGC WorldWeather capabilities document.
                ...
                if (child.localName === "Layer") {
                    ...
                    try {
                        ...
                        Logger.logMessage(Logger.LEVEL_SEVERE, "WmtsCapabilities", "constructor",
                            "Exception reading WorldWeather layer description: " + e.message);
                    }
                    ...
                    try {
                        ...
                        Logger.logMessage(Logger.LEVEL_SEVERE, "WmtsCapabilities", "constructor",
                            "Exception reading WorldWeather tile matrix set description: " + e.message);
                    }
                }
                // TODO: OtherSource
            }
