...
define([
    ...
    function (ArgumentError,
         ...
         * @constructor
         * @classdesc Represents a WorldWeather layer description from a WorldWeather Capabilities document. This object holds all the
         * fields specified in the associated WorldWeather Capabilities document.
         * @param {{}} layerElement A WorldWeather Layer element describing the layer.
         * @param {{}} capabilities The WorldWeather capabilities documented containing this layer.
        ...
        var WmtsLayerCapabilities = function (layerElement, capabilities) {
            ...
            /**
             * This layer's WorldWeather capabilities document, as specified to the constructor of this object.
             * @type {{}}
             * @readonly
             */
