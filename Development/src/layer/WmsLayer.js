    ...
    function (ArgumentError,
        ...
        WmsLayer.formLayerConfiguration = function (wmsLayerCapabilities) {
            ...
            if (wmsLayerCapabilities.extents && wmsLayerCapabilities.extents.length > 0)
            {
                ...
                {
                    if (wmsLayerCapabilities.extents[i].name == "time")
                    {
            ...
            if (wmsLayerCapabilities.styles && wmsLayerCapabilities.styles.length > 0)
            {
                config.legend = wmsLayerCapabilities.styles[0].legendUrls[0].url;
            }
