...
define([
    ...
    function (AbsentResourceList,
        ...
        /**
         * Constructs a WorldWeather image layer.
         * @alias WmtsLayer
         * @constructor
         * @augments Layer
         * @classdesc Displays a WorldWeather image layer.
         ...
         *     <li>service: {String} The URL of the WorldWeather server</li>
         ...
         * </ul>
         * @param {String} timeString The time parameter passed to the WorldWeather server when imagery is requested. May be
         ...
         * @param wmtsLayerCapabilities {WmtsLayerCapabilities} The WorldWeather layer capabilities to create a configuration for.
        ...
        WmtsLayer.formLayerConfiguration = function (wmtsLayerCapabilities, style, matrixSet, imageFormat) {
	        ...
	        {
		        for (var a = 0; a < wmtsLayerCapabilities.dimension.length; a++)
		        {
			        if (wmtsLayerCapabilities.dimension[a].identifier && wmtsLayerCapabilities.dimension[a].identifier == "time")
			        {
            ...
            if (!config.resourceUrl && !config.service) {
                throw new ArgumentError(
                    Logger.logMessage(Logger.LEVEL_SEVERE, "WmtsLayer", "formLayerConfiguration",
                        "No resource URL or KVP GetTile service URL specified in WorldWeather capabilities."));
            }
        ...
        WmtsLayer.prototype.resourceUrlForTile = function (tile, imageFormat) {
            ...
            if (this.resourceUrl) {
                ...
                url = this.serviceUrl + "service=WorldWeather&request=GetTile&version=1.0.0";
